...
//methode geefAlleElementenKleinerDan oproepen
    ...
    //------------------------------------------------------------------------
	private <E extends Comparable<E>> E minimum(Collection<E> integerLijst) {
		// TODO Auto-generated method stub
		return integerLijst.stream().min(E::compareTo).get();
	}
    ...
    //-------------------------------------------------------------------------------------
	private <E extends Comparable<E>> List<E> geefAlleElementenKleinerDan(Collection<E> integerLijst, E grens) {
		// TODO Auto-generated method stub
		return integerLijst.stream().filter(elem->elem.compareTo(grens)<0).collect(Collectors.toList());
	}
}
