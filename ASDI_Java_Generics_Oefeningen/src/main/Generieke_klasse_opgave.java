...
class VerzamelingHuisdier<  T >
{
	...
	//------------------------------------------------------------
	public void add(T huisdier) { // geen generieke methode! Type ligt al vast in compilatie
...
//---------------------------------------------------------------------------------------
	public static boolean bevatHuisdier(Huisdier hd, Set<? extends Huisdier> dier) {
		return dier.contains(hd);
		
	}
//schrijf de static methode bevatHuisdier2 d.m.v. generieke methode
//---------------------------------------------------------------------------------------

	public static <T extends Huisdier> boolean bevatHuisdier2(T kat, Set<T> huisdieren) {
		// TODO Auto-generated method stub
		return false;
	}

	public static int geefAantal(Set<? super Kat> huisdieren) {
		// TODO Auto-generated method stub
		return huisdieren.size();
	}
