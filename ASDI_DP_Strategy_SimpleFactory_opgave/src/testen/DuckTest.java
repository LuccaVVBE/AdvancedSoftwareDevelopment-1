...
class DuckTest {
	...
	public void testDuck(DuckSpecies kind, String expectedDisplay, String expectedQuack, String expectedFly) {
		...
		Assertions.assertEquals(duck.performQuack(), expectedQuack);
		Assertions.assertEquals(duck.performFly(), expectedFly);
	}
	...
	public void wijzigAtRuntime(DuckSpecies kind) {
		...
		Assertions.assertEquals(duck.performFly(), flyRocketPowered);
	}
