...
//---------------------------------------------------------------------------------------
	public static boolean  bevatHuisdier(Huisdier hd, Set<? extends Huisdier> setDier) {
		return setDier.contains(hd);
	}
...
//---------------------------------------------------------------------------------------
	public static <T extends Huisdier> boolean bevatHuisdier2(T kat, Set<T> huisdieren) {
		...
		return huisdieren.contains(kat);
	}
...
//---------------------------------------------------------------------------------------	
	public static int geefAantal(Set<? super Kat> setKatOfHoger) {
		return setKatOfHoger.size();
	}
