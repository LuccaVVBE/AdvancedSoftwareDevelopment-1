...
class ReductiebonBeheerderTest {
	...
	public void testVraag3() {
		Reductiebon[] reductiebonArray = {new Reductiebon("R10", 20, LocalDate.of(2022, 5, 15)),
	...
	public void testVraag4() {
		...
		LocalDate[] verwachteResultaat = { LocalDate.of(2022, 5, 15), LocalDate.of(2022, 6, 1),
				LocalDate.of(2022, 9, 20), LocalDate.of(2022, 10, 26) };
		for (int i = 0; i < verwachteResultaat.length; i++)
