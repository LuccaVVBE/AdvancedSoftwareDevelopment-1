...
// de waarde is naam en voornaam van Auteur.
        ...
        //-------------------------------------------------------------------------------
        auteurs.put(9876,  new Auteur("Gossling","James"));
        auteurs.put(5648,  new Auteur("Chapman","Steve"));
        //Wijzig de voornaam van Chapman: John ipv Steve
        //----------------------------------------------
        //auteurs.replace(5648, new Auteur("Chapman","John")); Niet, want je vernietigd bestaand object.
        ...
        //---------------------------------------------------------------
        Map<Integer, Auteur> tMap = new TreeMap<>(auteurs);
        toonAlleSleutels(tMap);
    }
    ...
    public void toonAlleAuteurs(Map<Integer, Auteur> map) {
        ...
        //---------------------------------------------------------------
    	map.forEach((auteurId, auteur)->System.out.printf("%d\t%s%n",auteurId, auteur));
    }
